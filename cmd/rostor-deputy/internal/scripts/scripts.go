// Package scripts is the deputy half of SPEC-scripts (contract §1.4): it
...
// exactly what the deputy verifies.
...
// deputy has no key-id map, and trying every CA is cheap.
