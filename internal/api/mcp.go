...
func (s *Server) mcpTools() []mcpTool {
	...
	return []mcpTool{
		...
		{Name: "scripts_list", Schema: schema(map[string]any{}), Method: "GET", Path: func(a map[string]any) string { return "/v1/admin/scripts" }},
		{Name: "script_get", Schema: schema(map[string]any{"id": sProp("script id")}, "id"), Method: "GET",
			Path: func(a map[string]any) string { return "/v1/admin/scripts/" + esc(str(a, "id")) }},
		{Name: "script_create", Schema: schema(map[string]any{"name": sProp("name"), "description": sProp("description"), "body": sProp("PowerShell body")}, "name", "body"), Method: "POST",
			Path: func(a map[string]any) string { return "/v1/admin/scripts" }, Body: func(a map[string]any) any { return pick(a, "name", "description", "body") }},
		{Name: "script_update", Schema: schema(map[string]any{"id": sProp("script id"), "name": sProp("name"), "description": sProp("description"), "body": sProp("PowerShell body")}, "id"), Method: "PUT",
			Path: func(a map[string]any) string { return "/v1/admin/scripts/" + esc(str(a, "id")) }, Body: func(a map[string]any) any { return pick(a, "name", "description", "body") }},
		{Name: "script_delete", Schema: schema(map[string]any{"id": sProp("script id")}, "id"), Method: "DELETE",
			Path: func(a map[string]any) string { return "/v1/admin/scripts/" + esc(str(a, "id")) }},
		{Name: "scripts_order", Schema: schema(map[string]any{"ids": map[string]any{"type": "array", "items": map[string]any{"type": "string"}, "description": "script ids in the order they should run"}}, "ids"), Method: "PUT",
			Path: func(a map[string]any) string { return "/v1/admin/scripts/order" }, Body: func(a map[string]any) any { return pick(a, "ids") }},
		{Name: "script_assign", Schema: schema(map[string]any{"id": sProp("script id"), "target_kind": map[string]any{"type": "string", "enum": []string{"all", "group"}},
			"target": sProp("resource type for all (workstation), or a group name"), "mode": map[string]any{"type": "string", "enum": []string{"immediate", "signin"}}}, "id", "target_kind", "target", "mode"), Method: "POST",
			Path: func(a map[string]any) string { return "/v1/admin/scripts/" + esc(str(a, "id")) + "/assignments" }, Body: func(a map[string]any) any { return pick(a, "target_kind", "target", "mode") }},
		{Name: "script_unassign", Schema: schema(map[string]any{"id": sProp("script id"), "assignment_id": sProp("assignment id")}, "id", "assignment_id"), Method: "DELETE",
			Path: func(a map[string]any) string {
